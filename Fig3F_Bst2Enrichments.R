...
data <- read.table("~/Desktop/Dropbox/BenNSCProject/Bst2/0.EdgeR/2Exp/OldBst2Pos_vs_OldBst2Neg/glmLRT-Exp2-O.pos.over.O.neg.all.txt", header = T)
...
colnames(rank) <- NULL
write.table(rank, file = "Bst2_broadGSEA.rnk", quote = F, row.names = FALSE, sep = "\t")

#==================================================================================================
# GSEA 
# The Broad GSEA GUI was used here, with parameters recorded as a command line:
...
setwd("~/Desktop/Dropbox/BenNSCProject/Bst2/3.GSEA/OldBst2Pos_vs_OldBst2Neg/") # CUSTOMIZE

#==================================================================================================
# Process .xls file generated by GSEA into a dataframe for plotting.
# CUSTOMIZE the following three paths:
GSEA_OUTPUT_PATH <- "./05.02.18_broadGSEA.classic.h.all.v6.1.symbols.BST2.GseaPreranked.1525281836259/"
...
p<-p+theme_classic() + ggtitle("Hallmark Signatures - Oligodendrocytes")
...
p
#ggsave("CUSTOM_PLOTS/gseaHallmarksBarplot_ES_fdrCutoff0.01.pdf", p, height = 8, width = 8)
